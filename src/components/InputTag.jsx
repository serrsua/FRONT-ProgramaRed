    ...
    return (
        <Grid numCols={3} className='gap-2'>
            <Col numColSpan={2} className='flex flex-grow'>
                <input style={{ paddingLeft: 10 }} name='tag' value={tag} onChange={(e) => setTag(e.target.value)} placeholder='Ingrese un tag' />
            </Col>
            <Button size='xs' className='w-fit' color='emerald' onClick={() => onSearch(tag)}>
