                    ...
                    >
                      <div className=" flex flex-col">
                        ...
                        <button
                          ...
                          className={email.length !== 0 && !errors.email && !disable ?   "p-2 m-4 self-center font-medium rounded-md bg-ligthGreen transition-all duration-500 hover:bg-mediumGreen hover:scale-110" : "p-2 m-4 self-center font-medium rounded-md bg-ligthGreen disabled:opacity-60"}
                        >
                          Actualizar correo
                        </button>
                      </div>
