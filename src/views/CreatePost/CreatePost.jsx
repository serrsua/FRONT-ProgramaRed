...
import SubiendoPost from "../../images/SubiendoPost.gif"
...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("FILES abajo del setLoading: ",form.files);
    ...
    <div className="DIV_CREATEPOST block my-8 px-4 w-full">
      {
        ...
        : 
        (
          <div className="max-w-[600px] mt-[10%] mx-auto p-6 bg-white rounded-md shadow-md w-full">
            <img src={SubiendoPost} alt="" />
          </div>
        )
      }
    </div>
